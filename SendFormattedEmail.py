...
obj.add_user("rkm", 234.234 , email='rkm.sahajpur@gmail.com')    #here Add Some user name and Mail id place off these 
obj.add_user("hello", 23.32, email='rkm.hacker@gmail.com')
